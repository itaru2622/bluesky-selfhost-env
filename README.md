...
at current, my latest release is <strong>2025-02-09</strong> based on codes <strong>2025-02-09</strong> of bluesky-social.<br>
...
#    2025-02-09(for latest prebuild, in %Y-%m-%d), or latest (following docker image naming manner in lazy).
export asof=2025-02-09
