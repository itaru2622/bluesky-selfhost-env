...
Currently, my latest release is <strong>2026-09-13</strong>, based on the <strong>2026-09-13</strong> code from bluesky-social.<br>
...
#    Example: 2026-09-13 (latest prebuild) or 'latest' (following docker image naming).
export asof=2026-09-13
...
(cd ops-helper/apiImpl ; npm install; npm approve-scripts --all)
